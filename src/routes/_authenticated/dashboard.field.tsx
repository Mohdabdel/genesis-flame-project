  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">سجّل أداء المتعلم خطوة بخطوة داخل السيناريو الوظيفى للتدريب ، واحسب معامل الاستقلالية بناءً على مستوى الدعم المستخدم.</p>
      </div>
